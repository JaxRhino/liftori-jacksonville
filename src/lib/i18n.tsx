...
export const STRINGS = {
  ...
  // ---- CityPay (Wave J) ----
  'bills.title':                 { en: 'My bills',                       es: 'Mis facturas' },
  'bills.subtitle':              { en: 'Every bill from the City of Jacksonville, in one place.', es: 'Cada factura de la Ciudad de Jacksonville, en un solo lugar.' },
  'bills.totalOwed':             { en: 'Total owed',                     es: 'Total adeudado' },
  'bills.openCount':             { en: 'open',                           es: 'abiertas' },
  'bills.overdueCount':          { en: 'overdue',                        es: 'vencidas' },
  'bills.payAll':                { en: 'Pay all open bills',             es: 'Pagar todas las facturas' },
  'bills.paySelected':           { en: 'Pay selected',                   es: 'Pagar seleccionadas' },
  'bills.allCaughtUp':           { en: 'All caught up!',                 es: 'Todo al dia!' },
  'bills.allCaughtUpSub':        { en: 'You have no open bills with the City of Jacksonville.', es: 'No tienes facturas abiertas con la Ciudad de Jacksonville.' },
  'bills.status.open':           { en: 'Open',                           es: 'Abierta' },
  'bills.status.due_soon':       { en: 'Due soon',                       es: 'Vence pronto' },
  'bills.status.overdue':        { en: 'Overdue',                        es: 'Vencida' },
  'bills.status.paid':           { en: 'Paid',                           es: 'Pagada' },
  'bills.status.in_collections': { en: 'In collections',                 es: 'En cobranza' },
  'bills.status.payment_plan':   { en: 'Payment plan',                   es: 'Plan de pago' },
  'bills.due':                   { en: 'Due',                            es: 'Vence' },
  'bills.amount':                { en: 'Amount',                         es: 'Monto' },
  'bills.fee':                   { en: 'Service fee',                    es: 'Cargo por servicio' },
  'bills.total':                 { en: 'Total',                          es: 'Total' },
  'bills.from':                  { en: 'From',                           es: 'De' },
  'bills.notice':                { en: 'Notice / account #',             es: 'Numero de aviso / cuenta' },
  'bills.filter.all':            { en: 'All',                            es: 'Todas' },
  'bills.filter.open':           { en: 'Open',                           es: 'Abiertas' },
  'bills.filter.paid':           { en: 'Paid',                           es: 'Pagadas' },
  'bills.kind.property_tax':     { en: 'Property tax',                   es: 'Impuesto a la propiedad' },
  'bills.kind.business_tax':     { en: 'Business tax',                   es: 'Impuesto comercial' },
  'bills.kind.utility':          { en: 'JEA utility',                    es: 'Servicios JEA' },
  'bills.kind.stormwater':       { en: 'Stormwater',                     es: 'Aguas pluviales' },
  'bills.kind.parking_ticket':   { en: 'Parking ticket',                 es: 'Multa de estacionamiento' },
  'bills.kind.traffic_citation': { en: 'Traffic citation',               es: 'Multa de transito' },
  'bills.kind.red_light_camera': { en: 'Red light camera',               es: 'Camara de luz roja' },
  'bills.kind.ambulance':        { en: 'Ambulance bill',                 es: 'Factura de ambulancia' },
  'bills.kind.code_violation':   { en: 'Code violation',                 es: 'Violacion de codigo' },
  'bills.kind.building_permit':  { en: 'Building permit',                es: 'Permiso de construccion' },
  'bills.kind.dog_tag':          { en: 'Dog tag',                        es: 'Licencia de perro' },
  'bills.kind.parks_permit':     { en: 'Parks permit',                   es: 'Permiso de parques' },
  'bills.kind.other_fee':        { en: 'Other fee',                      es: 'Otro cargo' },

  'pay.title':                   { en: 'Pay bills',                      es: 'Pagar facturas' },
  'pay.summary':                 { en: 'Summary',                        es: 'Resumen' },
  'pay.subtotal':                { en: 'Subtotal',                       es: 'Subtotal' },
  'pay.serviceFee':              { en: 'Service fee',                    es: 'Cargo por servicio' },
  'pay.cardLast4':               { en: 'Card ending in',                 es: 'Tarjeta terminada en' },
  'pay.cardNumber':              { en: 'Card number',                    es: 'Numero de tarjeta' },
  'pay.expiry':                  { en: 'Exp',                            es: 'Vence' },
  'pay.cvc':                     { en: 'CVC',                            es: 'CVC' },
  'pay.zip':                     { en: 'ZIP',                            es: 'Codigo postal' },
  'pay.payNow':                  { en: 'Pay now',                        es: 'Pagar ahora' },
  'pay.cancel':                  { en: 'Cancel',                         es: 'Cancelar' },
  'pay.processing':              { en: 'Processing...',                  es: 'Procesando...' },
  'pay.success':                 { en: 'Payment confirmed',              es: 'Pago confirmado' },
  'pay.receiptNumber':           { en: 'Receipt #',                      es: 'Recibo #' },
  'pay.thanks':                  { en: 'Thank you. Your receipt is below.', es: 'Gracias. Tu recibo esta abajo.' },
  'pay.printReceipt':            { en: 'Print receipt',                  es: 'Imprimir recibo' },
  'pay.emailReceipt':            { en: 'Email receipt',                  es: 'Enviar recibo por correo' },
  'pay.done':                    { en: 'Done',                           es: 'Listo' },
  'pay.demoNotice':              { en: 'Demo mode — Stripe test card. No charge.', es: 'Modo demostracion — tarjeta de prueba Stripe. Sin cargo.' },
  'pay.replaces':                { en: 'Replaces 12 separate city payment systems.', es: 'Reemplaza 12 sistemas de pago municipales separados.' },

  'finance.title':               { en: 'Finance',                        es: 'Finanzas' },
  'finance.subtitle':            { en: 'Citizen bills, payments, aging — across every department.', es: 'Facturas, pagos, antiguedad — en cada departamento.' },
  'nav.finance':                 { en: 'Finance',                        es: 'Finanzas' },
