        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-sm font-semibold tracking-wide uppercase">City of Jacksonville</span>
              <span className="text-[11px] text-jax-sky uppercase tracking-widest">Powered by Liftori</span>
            </div>
          </Link>
              ...
              <>
                <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-md bg-jax-navy-deep/50 border border-jax-blue/30">
                  ...
                  <div className="text-xs leading-tight">
                    ...
                    <div className="text-jax-sky uppercase tracking-wider text-[10px]">{role || 'citizen'}</div>
                  </div>
                </div>
                <button
